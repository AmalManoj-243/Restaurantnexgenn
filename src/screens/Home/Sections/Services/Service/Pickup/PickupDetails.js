...
const PickupDetails = ({ navigation, route }) => {
    ...
    return (
        ...
        <RoundedScrollContainer>
            ...
            <DetailField label="PickUp Schedule" value={formatDateTime(details?.pickup_schedule_time)} />
            ...
            <DetailField label="Coordinator Signature" value={details?.service_coordinator_signature} />
